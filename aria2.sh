...
cd $local_folder
trackers_list=$(wget --no-check-certificate -qO- https://trackerslist.com/http.txt)
...
curl -LO https://github.com/abcfy2/aria2-static-build/releases/download/1.37.0/aria2-x86_64-linux-musl_static.zip
unzip aria2-x86_64-linux-musl_static.zip
rm aria2-x86_64-linux-musl_static.zip
mv aria2c /usr/bin/aria2c
